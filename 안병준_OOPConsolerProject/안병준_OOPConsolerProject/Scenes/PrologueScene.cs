...
namespace 안병준_OOPConsolerProject.Scenes
{
    public class PrologueScene : Scene
    {
        ...
        public override void Render()
        {
            ...
            Print("누구도 그가 어디로 갔는지, 왜 떠났는지 알지 못하고 소문만 무성했는데\n");
            Print("어떤 이는 그의 행방에 대해 죽었다하고, \n또 어떤 이는 그가 진정한 악을 보았고 또 다시 세상을 지키러 떠났다고 한다.\n");
            Print("그의 행방은 수수께끼로 남았고, 그 수수께끼를 풀기위해 모험가인 당신은 그를 찾는 여정을 시작한다.\n");
